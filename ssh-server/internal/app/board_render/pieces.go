...
func WhiteQueenDarkSquare12(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		...
		style.Foreground(WhitePieceColor).Background(DarkSquareColor).Render(" ") + style.Foreground(DarkSquareColor).Background(WhitePieceColor).Render("▊") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("        ") + style.Foreground(WhitePieceColor).Background(DarkSquareColor).Render("▎") + style.Foreground(DarkSquareColor).Background(DarkSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(DarkSquareColor).Render(" ") + style.Foreground(DarkSquareColor).Background(DarkSquareColor).Render(" ") + style.Foreground(DarkSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("      ") + style.Foreground(DarkSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(DarkSquareColor).Background(DarkSquareColor).Render(" ▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(DarkSquareColor).Render(" ") + style.Foreground(DarkSquareColor).Background(DarkSquareColor).Render(" ") + style.Foreground(DarkSquareColor).Background(WhitePieceColor).Render("▅▅▅▅▅▅▅▅") + style.Foreground(DarkSquareColor).Background(DarkSquareColor).Render("  \x1b[0m"),
	}
}
...
func WhitePawnLightSquare8(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		...
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ▗▄▄▖  \x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▄▄▄") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▘ ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
...
func WhitePawnLightSquare10(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▁▁") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▎") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("  ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▊  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ▝") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▄▄") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▘  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ▟▇▇▙") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▅▅▅▅") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
...
func WhitePawnLightSquare12(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("    ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("    ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▟") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("  ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▙") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▁") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("  ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▁") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▂▂▂▂") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ▗") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render(" ⎽⎽ ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▖  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▆▆▆▆▆▆") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
func WhiteBishopLightSquare8(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ┏▌  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ▗") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ━") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▖ ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▙▁▂▟") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("━") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▃▃▃▃") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("━") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
...
func WhiteBishopLightSquare10(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▅▅") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▌\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▄") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ▂") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▌\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▊") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("  ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▆") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▌\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▁") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▘▄▄▝") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▁") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ▌\x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▝") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▄▄▄▄▄▄") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("╴") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
	}
}
...
func WhiteBishopLightSquare12(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("     ▅▄") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("  ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▗") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("  ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▌") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("  ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▝") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▅▖") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ▝") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("   ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▘  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▁▅▄") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("━━") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▄▅▁") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" │\x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▅▅▅▅▅▅▅▅") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▌\x1b[0m"),
	}
...
func WhiteKnightLightSquare8(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ▄▂▃▃▂") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▌") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("    ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▎") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("   ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▇") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▃▃▃▃") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▘ ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
...
func WhiteKnightLightSquare10(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▗▂▁▂▂▂ ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▊") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▆") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("     ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▊") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("    ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▂▄▆") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▌") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("    ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▝") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▙▄▄▄▄▄") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
...
func WhiteKnightLightSquare12(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▂ ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▁▁▁") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("  ▊\x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("╺▄") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("   ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▖") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▎") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("      ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ▟") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▊") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("     ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("╺▆") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▊") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("     ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▅▅▅▅▅▅") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▘  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
func WhiteRookLightSquare8(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▎") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▗▄▗▖▄▖ \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▎") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▌▁▁▁▁") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▌ \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▎") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▎") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▇▇▇") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▎ ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▄▄▄▄") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
...
func WhiteRookLightSquare10(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ▃▖▃▃▗▃  \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▊") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("▎") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▝  ▘") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("▊") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▎ \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▅━━━━▅") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▊") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("    ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▎  \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▎ ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▝") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▅▅▅▅") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▘ ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
...
func WhiteRookLightSquare12(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ▂▂ ▂▂ ▂▂") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▎") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("┗") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("▎▊") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("┛") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▊  \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▎▁▁▁▁▁▁") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▊") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▌") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▆▆▆▆▌") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▎") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("    ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▎") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▅▅▅▅▅▅") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
...
func WhiteKingLightSquare8(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▎") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ▄▄") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▃▄") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▜▛") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▄▄") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▊") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("   ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("  ") + style.Background(LightSquareColor).Background(WhitePieceColor).Render("▎\x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▎") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▙▃▃▃▃▟") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
...
func WhiteKingLightSquare10(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   ▄▄") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("   \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│ ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▁ ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▄▄") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ▁") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▘") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("▇ ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▙▟") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("  ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▝") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▖") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("      ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▎") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▇▄▄▄▄▄▄▇") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
...
func WhiteKingLightSquare12(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		...
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("│") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▊▁▁") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▎") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("  ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▎") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▗▅▆▅▖▗▅▆▅▖") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▎") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▎") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("   ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("  ") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("   ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▊") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▎") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▌") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("        ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▟") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▎ ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▅▅▅▅▅▅▅▅") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
...
func WhiteQueenLightSquare8(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("      ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▝") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▃") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("  ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▃") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▘") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▎") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("    ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▊ \x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ▝") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▃▃▃▃") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▘") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
...
func WhiteQueenLightSquare10(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render("  ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("      ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ▊\x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▎") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▖ ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▘▝") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ▗▊") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▌") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▇") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render(" ▇") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▇") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▌") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▊") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("      ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▎") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▄▄▄▄▄▄") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
	}
}
...
func WhiteQueenLightSquare12(WhitePieceColor lipgloss.Color, BlackPieceColor lipgloss.Color, LightSquareColor lipgloss.Color, DarkSquareColor lipgloss.Color) []string {
	...
	return []string{
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("           ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▗▁") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("  ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▘▝") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("  ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▁▖") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▊ ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▄") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▘") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("  ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▝") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▄") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▎") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" \x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▊") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("        ") + style.Foreground(WhitePieceColor).Background(LightSquareColor).Render("▎") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(WhitePieceColor).Background(WhitePieceColor).Render("      ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ▊\x1b[0m"),
		style.Foreground(WhitePieceColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render(" ") + style.Foreground(LightSquareColor).Background(WhitePieceColor).Render("▅▅▅▅▅▅▅▅") + style.Foreground(LightSquareColor).Background(LightSquareColor).Render("  \x1b[0m"),
	}
}
